    ...
    <div class="card-body">
      ...
      <form method="post">
        ...
        <div class="form-group">
          ...
          <input type="radio" value="<?= $person->sexo; ?>" name="sexo" id="sexo" value="1" checked> Hombre<br>
          <input type="radio" value="<?= $person->sexo; ?>" name="sexo" id="sexo" value="0" checked> Mujer<br>
        </div>
        ...
        <div class="form-group">
          <button type="submit" class="btn btn-info">Actualizar persona</button>
        </div>
      </form>
    </div>
  </div>
